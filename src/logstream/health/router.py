...
from logstream.health.health_env import health_settings
from logstream.health.service import check_cert, check_http, check_kafka, check_mongodb
...
async def health():
    ...
    for name, url in {
        ...
        "loki": health_settings.LOKI_HEALTH_URL,
    }.items():
